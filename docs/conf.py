...
project = "PeakRDL-rust"
copyright = f"{datetime.datetime.now().year}, Dana Sorensen"
...
html_theme_options = {
    "repository_url": "https://github.com/darsor/PeakRDL-rust",
