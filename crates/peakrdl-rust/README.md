...
This crate contains the types and traits implemented by the generated code and should be added as a dependency when using code generated by PeakRDL-rust. To actually generate the code, see the [peakrdl-rust-build](https://docs.rs/peakrdl-rust-build) crate.
